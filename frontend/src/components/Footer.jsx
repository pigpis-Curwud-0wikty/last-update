...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#151515] text-white mt-24">
      <div className="px-4 sm:px-[2vw] md:px-[2vw] lg:px-[3vw] pt-20 pb-30">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              <li><a onClick={() => {
                setShowSearch(true);
                navigate("/collection");
              }} className="hover:text-white transition-colors cursor-pointer">Search</a></li>
              <li><a href="/policy" className="hover:text-white transition-colors cursor-pointer">Return & Exchange Policy</a></li>
              <li><a href="/about" className="hover:text-white transition-colors cursor-pointer">About</a></li>
              <li><a href="/contact" className="hover:text-white transition-colors cursor-pointer">Contact Info</a></li>
            </ul>
          </div>
        ...
        {/* Bottom row: language/currency, payments, copyright */}
        <div className="mt-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 text-xs text-gray-400">
          <div className="flex items-center gap-3">
            ...
            <select className="bg-transparent border border-gray-600 px-3 py-2">
              <option className="text-black">Egypt (EGP)</option>
        ...
        <div className="flex items-center gap-2 ml-auto md:ml-0 mt-10">
          {/* Apple Pay */}
          <svg width="38" height="24" viewBox="0 0 165.521 105.965" aria-hidden="true">
            ...
            <path fill="#FFF" d="M150.698 3.532h1.672c.452.003.905.008 1.36.02.793.022 1.719.065 2.583.22.75.135 1.38.34 1.984.648a6.392 6.392 0 0 1 2.804 2.807c.306.6.51 1.226.645 1.983.154.854.197 1.783.218 2.58.013.45.019.9.02 1.36.005.557.005 1.113.005 1.671v76.318c0 .558 0 1.114-.004 1.682-.002.45-.008.9-.02 1.35-.022.796-.065 1.725-.221 2.589a6.855 6.855 0 0 1-.645 1.975 6.397 6.397 0 0 1-2.808 2.807c-.6.306-1.228.511-1.971.645-.881.157-1.847.2-2.574.22-.457.01-.912.017-1.379.019-.555.004-1.113.004-1.669.004H14.8c-.55 0-1.1 0-1.66-.004-.45-.002-.9-.007-1.35-.018-.744-.02-1.71-.064-2.584-.22a6.938 6.938 0 0 1-1.986-.65 6.337 6.337 0 0 1-1.622-1.18 6.355 6.355 0 0 1-1.178-1.623 6.935 6.935 0 0 1-.646-1.985c-.156-.863-.2-1.788-.22-2.578a66.088 66.088 0 0 1-.02-1.355V14.474c0-.443.006-.887.022-1.325.022-.792.065-1.717.222-2.587a6.924 6.924 0 0 1 .646-1.981 6.386 6.386 0 0 1 1.624-1.18 6.96 6.96 0 0 1 1.98-.646c.865-.155 1.792-.198 2.586-.22.452-.012.905-.017 1.354-.02h1.677z" />
            <g fill="#000">
